...
const data = {
  ...
  ALMUERZOS: [
    { name: "Pollo Saltado ", desc: "Arroz salteado con cebolla larga, zanahoria y cebollín chino, preparado con soya, jengibre, ajonjolí, ajinomoto y pasta de ajo. Acompañado de pollo en cubos, tomate, cebolla roja y papas a la francesa.", 
      price: "$32.000", img: "" },
    { name: "Lomo Saltado ", desc: "Arroz salteado con cebolla larga, zanahoria y cebollín chino, preparado con soya, jengibre, ajonjolí, ajinomoto y pasta de ajo. Acompañado de lomo en cubos, tomate, cebolla roja y papas a la francesa.", 
      price: "$35.000", img: "" },
    { name: "Pollo Cremoso", desc: "Arroz salteado con cebolla roja, tocineta y champiñones, preparado con crema de leche, soya y ajinomoto, terminado con queso parmesano. Acompañado de pechuga de pollo y cebollín chino.", 
      price: "$35.000", img: "" },
    { name: "Lomo Cremoso", desc: "Arroz salteado con cebolla roja, tocineta y champiñones, preparado con crema de leche, soya y ajinomoto, terminado con queso parmesano. Acompañado de lomo y cebollín chino.", 
      price: "$40.000", img: "" },
    { name: "Wok Neom", desc: "Arroz salteado con cebolla larga, zanahoria y cebollín chino, preparado con pasta de ajo, soya, jengibre, ajonjolí y ajinomoto. Acompañado de cubos de pollo y lomo, medio chorizo artesanal de cerdo, raíz china, wonton frito y chicharrón.", 
      price: "$45.000", img: "" },
  ],
  ...
  CORTES_CARNES: [
    ...
    { name: "Costillas BBQ", desc: "Papas a la francesa o cascos, con ensalada coleslaw.", price: "$57.000", img: "" },
