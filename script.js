...
const data = {
  ...
  COCTEL: [
    ...
    { name: "Manhattan", desc: "", price: "$0", img: "" },
    { name: "Tom Collins", desc: "", price: "$0", img: "" },
    { name: "Martini", desc: "", price: "$0", img: "" },
    { name: "Mojito", desc: "", price: "$0", img: "" },
    { name: "Daiquiri", desc: "", price: "$0", img: "" },
    { name: "Southside", desc: "", price: "$0", img: "" },
    { name: "Mint Julep", desc: "", price: "$0", img: "" },
    { name: "Piña Colada", desc: "", price: "$0", img: "" },
    { name: "Tequila Sunrise", desc: "", price: "$0", img: "" },
    { name: "Vodka Sunrise", desc: "", price: "$0", img: "" },
    { name: "Cosmopolitan", desc: "", price: "$0", img: "" },
    { name: "Moscow mule", desc: "", price: "$0", img: "" },
    { name: "Cóctel Neom", desc: "", price: "$0", img: "" },
  ],
